<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="add_admin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  	<div class="modal-dialog modal-lg" role="document">
	 	<div class="modal-content">
			<div class="modal-header">
		  		<h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-user-shield"></i> Tambah Admin</h5>
		  		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			 		<span aria-hidden="true">&times;</span>
		  		</button>
			</div>
			<form id="admin" role="form" action="{{ route('upload.admin') }}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9">
							<input class="form-control" name="pendidikan" type="text" value="" placeholder="" required>
						</div>
					</div>
					<div class="form-group row">
