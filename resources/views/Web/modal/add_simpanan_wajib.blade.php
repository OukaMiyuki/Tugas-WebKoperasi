<!-- Modal -->
<div class="modal fade" id="simpananWajib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  	<div class="modal-dialog modal-dialog-centered" role="document">
	 	<div class="modal-content">
			<div class="modal-header">
		  		<h5 class="modal-title" id="exampleModalLongTitle"><i class="far fa-plus-square"></i> Tambah Simpanan Wajib</h5>
		  		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			 		<span aria-hidden="true">&times;</span>
		  		</button>
			</div>
			<form role="form" action="{{ route('tambah.simpanan_wajib') }}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="modal-body" id="simpanan_wajib">
			 		<div class="form-group row">
						...
						<div class="col-lg-3">
							<button type="button" class="btn btn-info" data-toggle="modal" data-dismiss="modal" data-target="#daftar_anggota_simpanan" class="btn btn-secondary">Member</button>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9">
							<input id="tanggalWajib" name="tanggal" class="form-control" type="text" value="" readonly="">
						</div>
					</div>
				</div>
