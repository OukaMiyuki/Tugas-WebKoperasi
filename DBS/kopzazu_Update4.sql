...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jan 2020 pada 10.49
...
(20, 'USR20200115-20', 'Miyuki Ouka', 'Member', 'Aktif', '2020-01-15 07:48:59', '2020-01-15 07:48:59');
...
(40, '2020_01_14_170622_create_tb_simpanan_pokoks_table', 14),
(41, '2020_01_14_170655_create_tb_simpanan_sukarelas_table', 14),
(42, '2020_01_14_171128_create_tb_simpanan_wajibs_table', 14);
...
('USR20200115-20', 43279482472938023, 'Miyuki Ouka', 'Laki-laki', 'tes', 'Jl. Brigjen Katamso No. 45 Janti Waru Sidoarjo', 'Sidoarjo', 61256, 'asukaloid.blog@gmail.com', 895604255942, 'KBAurVx', '2020-01-15 07:48:59', '2020-01-15 07:48:59');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_simpanan_pokoks`
--

CREATE TABLE `tb_simpanan_pokoks` (
  `id` int(11) NOT NULL,
  `kode_member` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `tb_simpanan_pokoks`
--

INSERT INTO `tb_simpanan_pokoks` (`id`, `kode_member`, `nama`, `jenis_simpanan`, `nominal`, `created_at`, `updated_at`) VALUES
(15, 'USR20200111-18', 'Moch. Dzati Amar  Wibianto', 'Simpanan Pokok', 100000, '2020-01-15 11:08:28', '2020-01-15 11:08:28'),
(16, 'USR20200111-19', 'M. Rizky Moneter', 'Simpanan Pokok', 100000, '2020-01-15 11:08:32', '2020-01-15 11:08:32'),
(17, 'USR20200115-20', 'Miyuki Ouka', 'Simpanan Pokok', 100000, '2020-01-15 11:08:36', '2020-01-15 11:08:36');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_simpanan_sukarelas`
--

CREATE TABLE `tb_simpanan_sukarelas` (
  `id` int(11) NOT NULL,
  `kode_member` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_simpanan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `tb_simpanan_sukarelas`
--

INSERT INTO `tb_simpanan_sukarelas` (`id`, `kode_member`, `nama`, `jenis_simpanan`, `nominal`, `created_at`, `updated_at`) VALUES
(3, 'USR20200111-18', 'Moch. Dzati Amar  Wibianto', 'Simpanan Sukarela', 150000, '2020-01-15 18:13:24', '2020-01-15 18:26:45'),
(4, 'USR20200111-19', 'M. Rizky Moneter', 'Simpanan Sukarela', 250000, '2020-01-15 18:13:39', '2020-01-15 11:13:52'),
(5, 'USR20200115-20', 'Miyuki Ouka', 'Simpanan Sukarela', 100000, '2020-01-15 18:13:52', '2020-01-15 11:14:02');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_simpanan_wajibs`
--

CREATE TABLE `tb_simpanan_wajibs` (
  `id` int(11) NOT NULL,
  `kode_member` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_simpanan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `tb_simpanan_wajibs`
--

INSERT INTO `tb_simpanan_wajibs` (`id`, `kode_member`, `nama`, `jenis_simpanan`, `nominal`, `created_at`, `updated_at`) VALUES
(7, 'USR20200111-18', 'Moch. Dzati Amar  Wibianto', 'Simpanan Wajib', 150000, '2020-01-15 11:08:43', '2020-01-15 11:08:43'),
(8, 'USR20200111-19', 'M. Rizky Moneter', 'Simpanan Wajib', 150000, '2020-01-15 11:08:52', '2020-01-15 11:08:52'),
(9, 'USR20200115-20', 'Miyuki Ouka', 'Simpanan Wajib', 150000, '2020-01-15 11:08:59', '2020-01-15 11:08:59');
...
(13, 'USR20200115-20', 'KBAurVx', 'jpg', '2020-01-15 07:48:59', '2020-01-15 07:48:59');
...
--
-- Indeks untuk tabel `tb_simpanan_pokoks`
--
ALTER TABLE `tb_simpanan_pokoks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kode_member` (`kode_member`);

--
-- Indeks untuk tabel `tb_simpanan_sukarelas`
--
ALTER TABLE `tb_simpanan_sukarelas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kode_member` (`kode_member`);

--
-- Indeks untuk tabel `tb_simpanan_wajibs`
--
ALTER TABLE `tb_simpanan_wajibs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kode_member` (`kode_member`);
...
--
-- AUTO_INCREMENT untuk tabel `tb_simpanan_pokoks`
--
ALTER TABLE `tb_simpanan_pokoks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `tb_simpanan_sukarelas`
--
ALTER TABLE `tb_simpanan_sukarelas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tb_simpanan_wajibs`
--
ALTER TABLE `tb_simpanan_wajibs`
...
--
-- Ketidakleluasaan untuk tabel `tb_simpanan_pokoks`
--
ALTER TABLE `tb_simpanan_pokoks`
  ADD CONSTRAINT `tb_simpanan_pokoks_ibfk_1` FOREIGN KEY (`kode_member`) REFERENCES `cek_ids` (`kode_member`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_simpanan_sukarelas`
--
ALTER TABLE `tb_simpanan_sukarelas`
  ADD CONSTRAINT `tb_simpanan_sukarelas_ibfk_1` FOREIGN KEY (`kode_member`) REFERENCES `cek_ids` (`kode_member`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_simpanan_wajibs`
--
ALTER TABLE `tb_simpanan_wajibs`
  ADD CONSTRAINT `tb_simpanan_wajibs_ibfk_1` FOREIGN KEY (`kode_member`) REFERENCES `cek_ids` (`kode_member`) ON DELETE CASCADE ON UPDATE CASCADE;
